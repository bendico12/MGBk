...
window.addEventListener('scroll', function() {
  ...
  document.querySelector('.slide2').addEventListener('click',function(){
    document.querySelector('.ytp').classList.remove('noshow');
  })
  document.querySelector('.ytp').addEventListener('click',function(){
    document.querySelector('.ytp').classList.add('noshow');
  })

  document.querySelector('.slide3').addEventListener('click',function(){
    document.querySelector('.player1').classList.remove('noshow');
  })
  document.querySelector('.player1').addEventListener('click',function(){
    document.querySelector('.player1').classList.add('noshow');
  })
 
  document.querySelector('.slide4').addEventListener('click',function(){
    document.querySelector('.player2').classList.remove('noshow');
  })
  document.querySelector('.player2').addEventListener('click',function(){
    document.querySelector('.player2').classList.add('noshow');
  })
  var isClose = false;
  function closeMovie(){
